 ...
 (function(t){
     t(function(){
        t("ul.navbar-nav").each(function(){
            var s=t(this);s.addClass("sm").smartmenus({
                ...
                "show.smapi":function(s,e){
                    ...
                    o&&o.css("background-color",t(document.body).css("background-color")),
                    i.parent().addClass("open"+(a.isCollapsible()?" collapsible":""))
                },
                ...
                "click.smapi":function(s,e){
                    ...
                    if(i.isCollapsible()){
                        var o=t(e),a=o.parent().dataSM("sub");
